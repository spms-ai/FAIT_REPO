...
* **Mensagem de Informação**: Representada pelo ícone <img alt="logo" src="img/capitulo4/InfoIcon.png" style="position:absolute; top:-10px;"> . Tem por objetivo apenas informar ao utilizador.
